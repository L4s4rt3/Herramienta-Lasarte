...
export function buildFacturasCampana2024_2025Rows(userId: string): ConsumoFisicoRow[] {
  ...
  const aguaRows = FACTURAS_CAMPANA_2024_2025_AGUA_CONSUMOS.map((row) => ({
    ...
    notas: `Campana 2024/2025. Aqua Campina ${row.facturacion}. Documento: ${row.documento}. Lecturas: ${row.lecturaAnterior} -> ${row.lecturaActual}. Dias: ${row.dias}. Fuente: ${row.fuenteImagen}.`,
    created_at: "2026-06-12T00:00:00.000Z",
