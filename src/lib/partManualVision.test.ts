...
describe("derivePartManualFields", () => {
  it("aplica las reglas confirmadas del papel del 21 de julio", () => {
    expect(derivePartManualFields(raw({
      ...
      // Desglose por zona (2026-07-29): bruto tal cual el papel + ⌈box⌉.
      kg_reciclado_malla_z1_bruto: 354,
      kg_reciclado_malla_z2_bruto: 354,
      box_reciclaje_z1: 2,
      box_reciclaje_z2: 2,
  ...
  it("guarda Cítrica como industria bruta y conserva nulos no detectados", () => {
    expect(derivePartManualFields(raw({
      ...
      kg_reciclado_malla_z1_bruto: null,
      kg_reciclado_malla_z2_bruto: null,
      box_reciclaje_z1: null,
      box_reciclaje_z2: null,
